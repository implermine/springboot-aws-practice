...
// Integration Test이므로, WebMvcTest를 사용하지 않았다.
// 책에 의하면, @WebMvcTest의 경우 JPA 기능이 작동하지 않기 때문이다.
...
class PostsApiControllerTest {
    ...
    public void Posts_등록된다_mvc() throws Exception {
        //given
        String title = "title";
        String content = "content";
        PostsSaveRequestDto requestDto = PostsSaveRequestDto.builder()
    ...
    @Test
    @WithMockUser(roles = "USER")
    public void Posts_수정된다_mvc() throws Exception {
        //given
        Posts savedPosts = postsRepository.save(Posts.builder()
                .title("title")
                .content("content")
